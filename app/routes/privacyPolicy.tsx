...
export default function Privacy() {
    return (
        <main className="bg-[#F9FAFB] text-white min-h-screen lg:px-0 px-2">
            {/* Header */}
            ...
            {/* Content */}
            <section className="max-w-7xl rounded-lg mx-auto flex flex-col md:flex-row gap-10 px-4 pb-20">
                {/* Sidebar */}
                        ...
                        {[
                            ...
                            <li
                                ...
                                className={`border rounded-md text-sm p-3 transition-colors ${index === 0
                                    ? "border-primary text-black font-semibold bg-white"
                                    : "border-gray-100 text-gray-700 bg-white hover:border-primary"
                                    }`}
                            >
                                {index + 1}. {item}
                            </li>
                ...
                {/* Main Content */}
                <article className="flex-1 p-8 leading-relaxed text-gray-700 text-sm">
